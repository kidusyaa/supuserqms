...
export default function Herosection() {
  ...
  return (
    <div 
      ...
      className="relative pb-[380px] md:pb-[180px] lg:pb-[200px] flex flex-col justify-start"
    >
      <div className='bg-tertiary h-[300px] lg:h-[400px] md:rounded-b-[200px] rounded-b-2xl'> {/* Corrected rounded-b-4xl to rounded-b-2xl assuming it was a typo for common tailwind sizes */}
